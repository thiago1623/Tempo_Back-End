...
#print(f"NORTEÑA  ARTISTA    ---->{artista_objeto}")
...
show = {
    "name_show": "script 1 - show3 2021-04-12 en un mes Norteña bogotá",
...
show2 = {
    "name_show": "script 1 - show3 2021-03-08 hoy Metal Medellín",
...
show3 = {
    "name_show": "script 1 - show3 2021-03-12 en 4 dias Pop Bogotá",
